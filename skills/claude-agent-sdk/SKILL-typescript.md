# Claude Agent SDK — TypeScript Reference (v0.3.159)

**Package**: `@anthropic-ai/claude-agent-sdk@0.3.159`
...
// 'model_not_found' — since v0.3.159: replaces generic 'invalid_request' when the selected
...
**Fix** (v0.3.159+): Use the new `@anthropic-ai/claude-agent-sdk/extract` subpath export:
```typescript
...
**Legacy workaround** (pre-v0.3.159): Set `pathToClaudeCodeExecutable` explicitly to the physical
...
**Last verified**: 2026-06-01 | **SDK version**: 0.3.159
