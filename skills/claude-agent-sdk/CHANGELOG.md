...
## 2026-06-01 (v0.3.159 — version bump)

- TypeScript SDK v0.3.158 → v0.3.159 (parity with Claude Code v2.1.159); no new API surface changes
- Version propagated to SKILL.md, SKILL-typescript.md, README.md, state.json

## 2026-05-31
- Docs index hash refreshed (bbd47141→6e6b703a); 30 pages audited; no version bump (TS v0.3.158, PY v0.2.87 unchanged); all 11 gates pass, 21/21 verify checks pass; $2.01 total

## 2026-05-30 (success run)
- Sync to CC v2.1.158 — TS v0.3.153→v0.3.158; all 11 gates pass, 27/27 verify checks pass; 1 mending run; $1.40 total

## 2026-05-30 (v0.3.158 — version bump)

- TypeScript SDK v0.3.153 → v0.3.158 (parity with Claude Code v2.1.158); no new API surface changes
- Docs index hash updated (6cef2ea2 → bbd47141); page count unchanged at 30; no new API surface changes
- Version propagated to SKILL.md, SKILL-typescript.md, README.md, state.json
...
## 2026-05-20
- *(pending review — see PR on `auto/2026-05-20-pending-review`)* Research-only run (TS v0.3.145, PY v0.2.82 unchanged); check-docs-drift failed; no upstream changes detected; 48 research turns, $0.52 (fourteenth run 23:46Z)
- *(pending review — see PR on `auto/2026-05-20-pending-review`)* Research-only run (TS v0.3.145, PY v0.2.82 unchanged); check-docs-drift failed; no upstream changes detected; 44 research turns, $0.48 (thirteenth run 22:52Z)
- *(pending review — see PR on `auto/2026-05-20-pending-review`)* Research-only run (TS v0.3.145, PY v0.2.82 unchanged); check-docs-drift failed; no upstream changes detected; 49 research turns, $0.63 (twelfth run 22:00Z)
