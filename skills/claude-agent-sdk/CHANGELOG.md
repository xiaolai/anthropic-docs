...
- Python SDK v0.2.83 → v0.2.84 (bundled Claude CLI updated to v2.1.147); TypeScript v0.3.147 unchanged
- Version propagated to SKILL.md, SKILL-python.md, README.md, state.json; no new API surface changes
