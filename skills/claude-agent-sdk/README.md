...
**TypeScript SDK**: v0.3.146 | **Python SDK**: v0.2.83
...
The shared pipeline at `pipeline/` runs hourly (matrix-iterates over all 8 skills; this one is one of them) and rewrites the surface files from the upstream docs + SDK type definitions whenever upstream changes are detected. See the [repo README](../../README.md) for the full pipeline mechanics.
...
|------|--------|----------|---------|--------|-------|-------|
| 2026-05-21 | success | CC v0.3.145 → v0.3.146 |
| 2026-05-20 | — | — | — | — | — | mixed (success + multiple review runs); session-storage.md added (29→30 pages) |
| 2026-05-19 | — | — | — | — | — | mixed (success + review runs); Task→Agent rename, updatedToolOutput, auto permissionMode, xhigh effort |
