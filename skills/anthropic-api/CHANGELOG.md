...
*(pending review — see draft PR `auto/2026-05-19-pending-review`)* Research agent completed docs audit across all surfaces; check-docs-drift gate failed — changes await human review before merge to main.
