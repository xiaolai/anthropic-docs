...
*(pending review — see draft PR `auto/2026-05-18-pending-review`)* First full baseline audit of all surfaces by research agent (113 turns); diff size exceeded gate threshold — changes await human review before merge.
