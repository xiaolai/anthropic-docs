...
*(pending review — see draft PR `auto/2026-05-19-pending-review`)* Research audit produced surface updates that exceeded checkDocsDrift and checkDiffSize thresholds; known-issue #964 (toolRunner container.id propagation) added pending review.
