...
## 2026-05-20
- Research-only run: no upstream version change detected; research agent audited all 6 surfaces (54 turns, 167s, $0.69); all 8 quality gates passed.
- Research-only run (earlier): no upstream version change detected; research agent audited all 6 surfaces (100 turns, 331s, $1.41); all 8 quality gates passed.
