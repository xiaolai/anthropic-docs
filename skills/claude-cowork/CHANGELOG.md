...
- *(pending review — see PR auto/2026-05-19-pending-review)* Research audit detected docs drift; changes held on branch pending manual review of check-docs-drift failure.
