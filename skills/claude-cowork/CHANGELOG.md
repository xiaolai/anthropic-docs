...
## 2026-05-18
*(pending review — see PR on `auto/2026-05-18-pending-review`)* — Removed `office-agents/overview.md` from tracked docs index (35 → 34 pages); check-docs-drift gate failed, changes held for human review.
