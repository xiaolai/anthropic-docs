...
*(pending review — see PR auto/2026-05-18-pending-review)* Initial docs audit — 35 pages indexed across cowork + office-agents surfaces; check-diff-size gate failed (first-run diff size expected to be large).
