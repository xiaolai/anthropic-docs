...
## 2026-05-19
*(pending review — see PR auto/2026-05-19-pending-review)* — Docs index sync: removed `office-agents/overview.md` (page count 35 → 34); check-diff-size gate triggered review hold.
