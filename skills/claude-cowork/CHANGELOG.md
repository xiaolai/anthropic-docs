...
## 2026-05-20 (run 6)
*(pending review — see branch `auto/2026-05-20-pending-review`)* Research agent re-ran (61 turns, 288 s, $0.91); check-docs-drift and check-diff-size failing — surface edits pending human review before merge.
