...
description: |
  ...
  for Outlook.
source: https://claude.com/docs/office-agents/enterprise-readiness.md
---
...
> **Note (2026-05-18):** `overview.md` was removed from the docs index.
> Content formerly on that page may have been consolidated into the
> per-app pages listed above.
