...
## 2026-05-20
*(pending review — see PR auto/2026-05-20-pending-review)* Sync to platform.claude.com docs — added 10 new pages (8 `agents-and-tools/mcp-tunnels/*`, 2 `managed-agents/self-hosted-sandboxes*`); page count 109 → 119; check-diff-size gate failed, changes on draft branch pending human review
