...
- Sync to platform.claude.com docs — added 10 new pages (mcp-tunnels ×8, self-hosted-sandboxes ×2; page count 109 → 119); check-diff-size gate failed, draft PR opened for review
