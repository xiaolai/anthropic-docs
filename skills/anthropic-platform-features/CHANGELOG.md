...
## 2026-05-20
- *(pending review — see PR auto/2026-05-20-pending-review)* Docs index 109 → 119 pages — added mcp-tunnels section (8 pages) and 2 managed-agents sandbox pages; check-diff-size gate blocked push to main
