...
## 2026-05-20
- *(pending review — see branch auto/2026-05-20-pending-review)* Docs expanded 109→119 pages — added `agents-and-tools/mcp-tunnels/` section (8 pages) and `managed-agents/self-hosted-sandboxes` (2 pages); check-diff-size gate triggered human review
