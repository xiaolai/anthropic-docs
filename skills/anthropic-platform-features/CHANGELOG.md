...
## 2026-05-19
*(pending review — see PR auto/2026-05-19-pending-review)* Sync to platform.claude.com docs — added 10 pages (mcp-tunnels ×8, managed-agents/self-hosted-sandboxes ×2), page count 109 → 119; check-diff-size failed, changes on draft branch
