...
## 2026-05-19
*(pending review — see PR auto/2026-05-19-pending-review)* Sync to platform.claude.com docs — added 10 pages: 8 MCP tunnels pages (agents-and-tools/mcp-tunnels/*) and 2 self-hosted sandboxes pages (managed-agents/), page count 109 → 119; check-diff-size gate failed due to large batch
