...
## 2026-05-20
- *(pending review — see branch auto/2026-05-20-pending-review)* Sync to platform.claude.com docs — added 10 new pages: 8 under `agents-and-tools/mcp-tunnels/` (full MCP Tunnels section), plus `managed-agents/self-hosted-sandboxes.md` and `managed-agents/self-hosted-sandboxes-security.md` (page count 109 → 119); check-diff-size gate failed
