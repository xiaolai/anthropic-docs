...
## 2026-05-20
- *(pending review — see branch auto/2026-05-20-pending-review)* Sync to platform.claude.com docs — added 10 new pages (MCP tunnels ×8, self-hosted sandboxes ×2); page count 109 → 119; check-diff-size gate triggered review
