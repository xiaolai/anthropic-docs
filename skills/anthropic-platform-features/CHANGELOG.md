...
- Sync to platform.claude.com docs — added 10 pages (mcp-tunnels ×8 under agents-and-tools, self-hosted-sandboxes ×2 under managed-agents); page count 109 → 119; checkDiffSize gate failed, changes queued for review
