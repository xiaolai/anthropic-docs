...
## 2026-05-19
- *(pending review — see PR auto/2026-05-19-pending-review)* Sync to platform.claude.com docs — added 10 new pages (mcp-tunnels ×8, managed-agents/self-hosted-sandboxes ×2; index 109 → 119); check-diff-size gate failed, draft PR opened for review
