...
|---|---|
| [`SKILL-agents-and-tools.md`](SKILL-agents-and-tools.md) | Agent Skills format spec, MCP connector, remote MCP servers, MCP tunnels (private-network MCP via outbound tunnel), tool use (computer use, code execution, bash, define-your-own tools), tool_choice |
