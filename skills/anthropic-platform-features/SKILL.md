...
|---|---|
| [`SKILL-agents-and-tools.md`](SKILL-agents-and-tools.md) | Agent Skills format spec, MCP connector, remote MCP servers, MCP Tunnels (private-network MCP servers via outbound tunnel), tool use (computer use, code execution, bash, define-your-own tools), tool_choice |
