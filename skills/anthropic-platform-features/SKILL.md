...
description: |
  ...
  Anthropic's hosted MCP connector, MCP tunnels (private-network MCP
  access without opening inbound ports), the computer-use tool, the
  ...
  sandboxes (running agent tool execution in your own infrastructure).
...
|---|---|
| [`SKILL-agents-and-tools.md`](SKILL-agents-and-tools.md) | Agent Skills format spec, MCP connector, remote MCP servers, MCP tunnels (private-network MCP access), tool use (computer use, code execution, bash, define-your-own tools), tool_choice |
