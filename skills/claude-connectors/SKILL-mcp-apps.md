...
- `icons` — icon paths, optionally per theme (light/dark) and size. Recommended: 512×512px PNG with transparency (minimum 256×256px). Place `icon.png` in the bundle root; reference in manifest.
