...
## 2026-05-19
- *(pending review — see draft PR `auto/2026-05-19-pending-review`)* Docs index content updated (34 pages, no additions/removals); check-docs-drift and check-diff-size gates failed — changes await manual review before merging to main
