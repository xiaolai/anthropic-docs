...
*(pending review — see branch `auto/2026-05-19-pending-review`)* — Synced docs index (34 pages, hash updated); initial population diff flagged by check-diff-size gate.
