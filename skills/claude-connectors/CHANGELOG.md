...
## 2026-05-19
*(pending review — see PR auto/2026-05-19-pending-review)* — Research run: 34 connector/skills/plugins pages audited and refreshed; review branch opened due to validate-examples, check-docs-drift, and check-diff-size gate failures
