...
| **Self-serve local MCP** | Local servers via npm/PyPI; bundle as MCPB for Desktop Extensions gallery, or bundle in a plugin via `.mcp.json` | [`overview.md`](https://claude.com/docs/connectors/overview.md) |
