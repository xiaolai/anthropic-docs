...
| **Self-serve local MCP** | Local servers distributed via npm/PyPI; package as MCPB for Desktop Extensions gallery or bundle via `.mcp.json` in a plugin and submit to the plugin directory | [`overview.md`](https://claude.com/docs/connectors/overview.md) |
