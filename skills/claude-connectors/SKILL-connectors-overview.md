...
| **Self-serve local MCP** | Local servers via npm/PyPI — not directly directory-listable; package as MCPB or bundle in a plugin via `.mcp.json` | [`overview.md`](https://claude.com/docs/connectors/overview.md) |
