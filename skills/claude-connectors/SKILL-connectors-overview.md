...
| **Self-serve local MCP** | Local servers via npm/PyPI — not directory-listable; package as MCPB for Desktop gallery or bundle in a plugin using `.mcp.json` | [`overview.md`](https://claude.com/docs/connectors/overview.md) |
