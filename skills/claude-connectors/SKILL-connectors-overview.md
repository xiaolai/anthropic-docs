...
| **Self-serve local MCP** | Local servers via npm/PyPI — cannot be listed in the Directory directly; package as MCPB or bundle in a plugin | [`overview.md`](https://claude.com/docs/connectors/overview.md) |
