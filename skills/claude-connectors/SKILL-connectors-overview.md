...
| **Self-serve local MCP** | Local servers distributed via npm/PyPI cannot be listed in the directory — package as MCPB for the Desktop Extensions gallery, or bundle in a plugin using `.mcp.json` and submit to the plugin directory | [`overview.md`](https://claude.com/docs/connectors/overview.md) |
