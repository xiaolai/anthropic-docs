...
|------|--------|----------|---------|--------|-------|-------|
| 2026-06-01 | success | CC v2.1.158 → v2.1.159 |
| 2026-05-31 | success | docs +2/-0 |
| 2026-05-30 | success | CC v2.1.156 → v2.1.159; docs +0/-30 |
| 2026-05-29 | success | CC v2.1.153 → v2.1.159; docs +1/-30 |
| 2026-05-28 | partial | CC v2.1.152 → v2.1.159; docs +0/-30 |
| 2026-05-27 | partial | CC v2.1.150 → v2.1.159; docs +2/-31 |
| 2026-05-27 (re-run) | — | $1.25 | $0.33 | — | **$1.59** | partial — update crashed (exit 1, SDK error); CC v2.1.150→v2.1.159; docs 110→111 pages (agent-sdk/* removed); all 8 gates pass |
