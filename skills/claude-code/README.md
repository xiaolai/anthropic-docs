...
|------|--------|----------|---------|--------|-------|-------|
| 2026-05-28 | partial | CC v2.1.152 → v2.1.153; docs +0/-30 |
| 2026-05-27 | partial | CC v2.1.150 → v2.1.153; docs +2/-31 |
| 2026-05-27 (re-run) | — | $1.25 | $0.33 | — | **$1.59** | partial — update crashed (exit 1, SDK error); CC v2.1.150→v2.1.153; docs 110→111 pages (agent-sdk/* removed); all 8 gates pass |
...
| 2026-05-23 | success | CC v2.1.148 → v2.1.153 |
