...
- Routine docs audit at v2.1.144 (no version bump) — check-populated gate failed; stub markers remain in one or more SKILL-*.md files; changes queued for review
